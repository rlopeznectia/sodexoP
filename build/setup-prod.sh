...
sfdx auth:jwt:grant --clientid $SFDC_UAT_CLIENTID_CLIENTID --jwtkeyfile JWT/server.key --username $SFDC_UAT_USER --instanceurl https://test.salesforce.com
sfdx alias:set my-hub-Prod=consultor_force@nectia.com.peru.prod
sfdx auth:jwt:grant --clientid $SFDC_PROD_CLIENTID --jwtkeyfile JWT/server.key --username $SFDC_PROD_USER --instanceurl https://sodexo-brs-peru.my.salesforce.com/
